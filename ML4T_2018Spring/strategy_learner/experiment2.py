...
def test_strategy(description, insample_args, outsample_args, benchmark_type, benchmark, impact, train_time, test_time, max_time, seed, grader):
    ...
    try:
        ...
        if not(incorrect):
            ...
            pd.DataFrame({description : [student_insample_cr]}).to_csv('{}_student_insample_experiment_2_extended_seed_{}.csv'.format(description, str(seed)))
