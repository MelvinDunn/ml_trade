...
def test_learners(description, group, datafile, seed, outputs, grader):
    ...
    try:
        ...
        if (group is 'BagLearner') or (group is 'RandomName') and (not 'BagLearner' in globals()):
        ...
        if (group is "RTLearner") or (group is "DTLearner"):
            ...
            predY_in, predY_out = run_with_timeout(oneleaf,tree_sptc,(),{})
            predY_in_50 = run_with_timeout(fiftyleaves,tree_sptc,(),{})
            np.cov(predY_in, y=trainY)
            ...
            def twentybags():
                ...
                random.seed = tmp_random_seed
                return q_rv
            predY1 = run_with_timeout(onebag,bag_sptc,pos_args=(),keyword_args={})
